...
from flamingo.integrations.huggingface import HuggingFaceRepoConfig, convert_string_to_repo
...
class AutoModelConfig(BaseFlamingoConfig):
    ...
    _validate_load_from = validator("load_from", pre=True, allow_reuse=True)(convert_string_to_repo)
